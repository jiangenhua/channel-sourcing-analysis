...
// ===== 8. Channel 质量打分维度 (Quality Scoring Rubric v2) =====
// v2 (2026-05-11): 移除「粉丝触达率」「类目偏好」(防止领域偏置);
//                  新增「横屏比例」+ 4 个绝对值维度 (Σ=20%)
// 注意: parts key 名约定 → res / horizontal / dur / engage / vcnt / like_rate
//                       / play_abs / like_abs / comment_abs / follower_abs
const QUALITY_DIMENSIONS = [
  ...
  },
  {
    ...
    c: { th: 0,  label: "<30%" },
    weight: 0.10,
    desc: "横屏视频占比, 横屏 = 高质量场景 (世界模型主流输出格式); 竖屏 = 低质量",
    note: "v1: 当前 channel 级横屏比例为按类目估算 (Shorts 5% / 多数类目 70-95%), 后续可替换为真实 SQL.",
  },
  {
    dim: "时长合规",
  ...
  },
  {
    ...
    c: { th: 0, label: "<1%" },
    weight: 0.15,
    desc: "(like+comment) / play × 100, 衡量内容粘性",
  },
  {
    dim: "视频量",
    field: "video_cnt",
  ...
  // ===== 4 个绝对值维度 (Σ=20%) =====
  {
    ...
    field: "total_play",
    key:  "play_abs",
    s: { th: 1_000_000_000, label: ">10 亿" },
    a: { th: 100_000_000,   label: "1-10 亿" },
    b: { th: 10_000_000,    label: "1000 万-1 亿" },
    c: { th: 0,             label: "<1000 万" },
    weight: 0.07,
    desc: "channel 累计播放总量 (绝对规模)",
  },
  {
    dim: "总点赞 (绝对值)",
    field: "total_like",
    key:  "like_abs",
    s: { th: 50_000_000, label: ">5000 万" },
    a: { th: 5_000_000,  label: "500 万-5000 万" },
    b: { th: 500_000,    label: "50-500 万" },
    c: { th: 0,          label: "<50 万" },
    weight: 0.06,
    desc: "channel 累计点赞总量 (绝对规模)",
  },
  {
    dim: "总评论 (绝对值)",
    field: "total_comment",
    key:  "comment_abs",
    s: { th: 1_000_000, label: ">100 万" },
    a: { th: 100_000,   label: "10-100 万" },
    b: { th: 10_000,    label: "1-10 万" },
    c: { th: 0,         label: "<1 万" },
    weight: 0.04,
    desc: "channel 累计评论总量 (绝对规模)",
  },
  {
    dim: "订阅数 (绝对值)",
    field: "follower",
    key:  "follower_abs",
    s: { th: 50_000_000, label: ">5000 万" },
    a: { th: 10_000_000, label: "1000-5000 万" },
    b: { th: 1_000_000,  label: "100-1000 万" },
    c: { th: 0,          label: "<100 万" },
    weight: 0.03,
    desc: "channel 粉丝/订阅数 (绝对规模)",
  },
];
